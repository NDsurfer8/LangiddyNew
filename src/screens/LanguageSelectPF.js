...
import { getPhraseCardsFromUserByLanguage } from "../../utils/actions/phraseActions";
...
const LanguageSelectPF = (props) => {
  ...
  const onLanguageSelect = useCallback(
    (itemKey) => {
      ...
      navigation.navigate("Flashcards", { [dataKey]: itemKey });
    },
    [params, navigation]
  );
...
export default LanguageSelectPF;
