  ...
  return (
    <PageContainer>
      <SafeAreaView>
        <ScrollView>
          <View>
            <Text style={styles.Headers}>Privacy policy</Text>
            <Text>
              ...
              you may provide (“Personal Information”) in the “Langiddy” mobile
              ...
              Information and how you can access and update it. This Policy is a
              ...
              access and use the Mobile Application and Services. By accessing
              and using the Mobile Application and Services, you acknowledge
          ...
          <View>
            ...
            <Text>
              ...
              someone could identify you as a specific, identifiable individual.
              If, however, you wish to use some of the features offered in the
              Mobile Application, you may be asked to provide certain Personal
              ...
              you create an account, publish content, or fill any forms in the
              Mobile Application. When required, this information may include
              the following: - Account details (such as user name, unique user
              ID, password, etc) - Contact information (such as email address,
              phone number, etc) - Basic personal information (such as name,
              country of residence, etc) - Certain features on the mobile device
              (such as contacts, calendar, gallery, etc) - Any other materials
              you willingly submit to us (such as articles, images, feedback,
              etc) You can choose not to provide us with your Personal
              Information, but then you may not be able to take advantage of
              some of the features in the Mobile Application. Users who are
              uncertain about what information is mandatory are welcome to
              contact us.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Privacy of children</Text>
            <Text>
              ...
              delete that child’s Personal Information from our Services. We
              ...
              Mobile Application and Services without their permission. We also
          ...
          <View>
            ...
            <Text>
              ...
              ensure your access and use of the Mobile Application and Services.
              ...
              controller. In order to make the Mobile Application and Services
              available to you, or to meet a legal obligation, we may need to
              collect and use certain Personal Information. If you do not
              provide the information that we request, we may not be able to
              provide you with the requested products or services. Any of the
              information we collect from you may be used for the following
              purposes: - Create and manage user accounts - Send product and
              service updates - Respond to inquiries and offer support - Request
              user feedback - Improve user experience - Enforce terms and
              conditions and policies - Protect from abuse and malicious users -
              Respond to legal requests and prevent harm - Run and operate the
              Mobile Application and Services Processing your Personal
              Information depends on how you interact with the Mobile
              Application and Services, where you are located in the world and
              if one of the following applies: (i) you have given your consent
              for one or more specific purposes; (ii) provision of information
              is necessary for the performance of an agreement with you and/or
              ...
              order to better serve you and to improve and update our Mobile
              Application and Services. Note that under some legislations we may
              ...
              other of the legal bases. In any case, we will be happy to clarify
          ...
          <View>
            <Text style={styles.Headers}>Managing information</Text>
            <Text>
              ...
              comply with our obligations to our affiliates and partners, and
              for the purposes described below. If you would like to delete your
              Personal Information or permanently delete your account, you can
              do so on the settings page of your account in the Mobile
              Application or simply by contacting us.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Disclosure of information</Text>
            <Text>
          ...
          <View>
            <Text style={styles.Headers}>Retention of information</Text>
            <Text>
              We will retain and use your Personal Information for the period
              necessary as long as your user account remains active, until the
              purchase order or Services are fulfilled, to enforce our
              agreements, resolve disputes, and unless a longer retention period
              is required or permitted by law. We may use any aggregated data
              ...
              right to erasure, the right to rectification, and the right to
              data portability cannot be enforced after the expiration of the
              retention period.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Data analytics</Text>
            <Text>
              ...
              to compile statistical reports on User activity such as how often
              Users visit our Mobile Application and Services, what pages they
          ...
          <View>
            <Text style={styles.Headers}>Social media features</Text>
            <Text>
              ...
              cookie to enable Social Media Features to function properly.
              Social Media Features are hosted either by their respective
              providers or directly on our Mobile Application and Services. Your
              interactions with these Social Media Features are governed by the
              privacy policy of their respective providers.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Push notifications</Text>
            <Text>
              ...
              devices, we use a third-party push notifications provider who
              relies on a device token unique to your device which is issued by
              the operating system of your device. While it is possible to
          ...
          <View>
            <Text style={styles.Headers}>Links to other resources</Text>
            <Text>
              The Mobile Application and Services contain links to other
              resources that are not owned or controlled by us. Please be aware
              that we are not responsible for the privacy practices of such
              other resources or third parties. We encourage you to be aware
              when you leave the Mobile Application and Services and to read the
              privacy statements of each and every resource that may collect
              Personal Information.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Information security</Text>
            <Text>
              ...
              information and data exchanged between you and the Mobile
              Application and Services cannot be guaranteed; and (iii) any such
              information and data may be viewed or tampered with in transit by
              a third party, despite best efforts. As the security of Personal
              Information depends in part on the security of the device you use
              to communicate with us and the security you use to protect your
              credentials, please take appropriate measures to protect this
              information.
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Data breach</Text>
            <Text>
              ...
              security attacks or fraud, we reserve the right to take reasonably
          ...
          <View>
            <Text style={styles.Headers}>Changes and amendments</Text>
            <Text>
          ...
          <View>
            <Text style={styles.Headers}>Acceptance of this policy</Text>
            <Text>
              ...
              Application and Services and submitting your information you agree
              ...
              Mobile Application and Services. This privacy policy was created
              with the help of WebsitePolicies.com
            </Text>
          </View>
          <View>
            <Text style={styles.Headers}>Contacting us</Text>
            <Text>
