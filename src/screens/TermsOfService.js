  ...
  return (
    <PageContainer>
      <SafeAreaView>
        <ScrollView>
          <View>
            <Text style={styles.Headers}>Terms and conditions</Text>
            <Text>
              These terms and conditions (“Agreement”) set forth the general
              terms and conditions of your use of the “Langiddy” mobile
              ...
              of this Agreement. You acknowledge that this Agreement is a
          ...
          <View>
            <Text style={styles.Headers}>Accounts and membership</Text>
            <Text>
              You must be at least 13 years of age to use the Mobile Application
              ...
              at least 13 years of age. If you create an account in the Mobile
          ...
          <View>
            <Text style={styles.Headers}>User content</Text>
            <Text>
              ...
              monitor and review the Content in the Mobile Application submitted
              ...
              perform the Content of your user account solely as required for
              the purpose of providing the Services to you. Unless specifically
              permitted by you, your use of the Mobile Application and Services
          ...
          <View>
            <Text style={styles.Headers}>Backups</Text>
            <Text>
              ...
              appropriate backup of your Content. Notwithstanding the foregoing,
          ...
          <View>
            <Text style={styles.Headers}>Prohibited uses</Text>
            <Text>
          ...
          <View>
            <Text style={styles.Headers}>Intellectual property rights</Text>
            <Text>
          ...
          <View>
            <Text style={styles.Headers}>Limitation of liability</Text>
            <Text>
          ...
          <View>
            <Text style={styles.Headers}>Severability</Text>
            <Text>
          ...
          <View>
            ...
            <Text>
              ...
              bottom of this page. We may also provide notice to you in other
              ways at our discretion, such as through the contact information
              you have provided. An updated version of this Agreement will be
              effective immediately upon the posting of the revised Agreement
          ...
          <View>
            <Text style={styles.Headers}>Acceptance of these terms</Text>
            <Text>
              ...
              Services. This terms and conditions policy was created with the
              help of WebsitePolicies.com
            </Text>
          </View>
          <View>
